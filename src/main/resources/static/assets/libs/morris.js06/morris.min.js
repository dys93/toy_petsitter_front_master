...
(function(){
    var a,b,c,d,e=[].slice,
        ...
        a=window.Morris={},
            ...
            a.extend=function(){
            var a,b,c,d,f,g,h;for(b=arguments[0],c=2<=arguments.length?e.call(arguments,1):[],null==b&&(b={}),g=0,h=c.length;h>g;g++)if(d=c[g],null!=d)for(a in d)f=d[a],d.hasOwnProperty(a)&&(b[a]=f);
            return b
            },
            a.offset=function(a){
            var b;
            return b=a.getBoundingClientRect(),{top:b.top+document.body.scrollTop,left:b.left+document.body.scrollLeft}
            },
            a.css=function(a,c){
            return b(a)[c]
            },
            ...
            var c;return c=b(a),{width:parseInt(c.width),height:parseInt(c.height)}
            },
            a.innerDimensions=function(a){
            var c;
            return c=b(a)
                , {width:parseInt(c.width)+parseInt(c.paddingLeft)+parseInt(c.paddingRight),height:parseInt(c.height)+parseInt(c.paddingTop)+parseInt(c.paddingBottom)}
            },
            a.Grid=function(b){
            function c(b){
                ...
                "string"==typeof this.options.units&&(this.options.postUnits=b.units),
                    this.raphael=new Raphael(this.el),this.elementWidth=null,this.elementHeight=null,
                    this.dirty=!1,
                ...
                this.options.rangeSelect&&(this.selectionRect=this.raphael.rect(0,0,0,a.innerDimensions(this.el).height).attr({fill:this.options.rangeSelectColor,stroke:!1}).toBack().hide(),
                    a.on(this.el,"mousedown",this.mousedownHandler),a.on(this.el,"mouseup",this.mouseupHandler)),
            ...
            return h(c,b),
                ...
                var c,d,e,f,g;return d=a.offset(this.el),g=b.pageX-d.left,this.selectFrom?(c=this.data[this.hitTest(Math.min(g,this.selectFrom))]._x,e=this.data[this.hitTest(Math.max(g,this.selectFrom))]._x,f=e-c,this.selectionRect.attr({x:c,width:f})):this.fire("hovermove",g,b.pageY-d.top)
                },
                ...
                var c,d;return d=b.originalEvent.touches[0]||b.originalEvent.changedTouches[0],c=a.offset(this.el),this.fire("hovermove",d.pageX-c.left,d.pageY-c.top)
                },
                c.prototype.clickHandler=function(b){var c;return c=a.offset(this.el),this.fire("gridclick",b.pageX-c.left,b.pageY-c.top)
                },
                c.prototype.mousedownHandler=function(b){
                var c;return c=a.offset(this.el),this.startRange(b.pageX-c.left)
                },
                c.prototype.mouseupHandler=function(b){
                var c;return c=a.offset(this.el),this.endRange(b.pageX-c.left),this.fire("hovermove",b.pageX-c.left,b.pageY-c.top)
                },
                ...
                var b,c,d;return this.timeoutId=null,d=a.dimensions(this.el),c=d.width,b=d.height,this.raphael.setSize(c,b),this.options.animate=!1,this.redraw()
                },
                c.prototype.hasToShow=function(a){
                return this.options.shown===!0||this.options.shown[a]===!0
                },
                c.prototype.isColorDark=function(a){
                var b,c,d,e,f;return null!=a?(a=a.substring(1),f=parseInt(a,16),e=f>>16&255,c=f>>8&255,b=f>>0&255,d=.2126*e+.7152*c+.0722*b,d>=128?!1:!0):!1
                },
        ...
        (a.EventEmitter),
            ...
            function b(b){
                ...
                return b.defaults={"class":"morris-hover morris-default-style"},
                    b.prototype.update=function(a,b,c,d){
                return a?(this.html(a),this.show(),this.moveTo(b,c,d)):this.hide()},b.prototype.html=function(a){
